            ...
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="login" type="text" name="login" value="{{ old('login') }}" required autofocus class="w-full px-4 py-3.5 text-base rounded-xl border border-gray-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#4298B4] focus:border-transparent transition-all" placeholder="Masukkan NIM atau Email">
                    ...
                    <div>
                        ...
                        <input id="password" type="password" name="password" required class="w-full px-4 py-3.5 text-base rounded-xl border border-gray-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-[#4298B4] focus:border-transparent transition-all" placeholder="Masukkan kata sandimu">
